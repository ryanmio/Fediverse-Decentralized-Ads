...
The document also outlines a strategy for [pilot testing and feedback collection](./docs/Decentralized_Advertising_Fediverse_ActivityPub.md#pilot-testing-feedback) before wider release.
